module.exports = {
  ...
  elements: {
    ...
    iFrame : {
        selector: 'div.jotform-iframe iframe'
    },
    ...
    commands: [{
        ...
        checkRoadPartnersTitle(title) {
            this
                .waitForElementVisible('@roadPartnersTitle', 10000)
                .expect.element('@roadPartnersTitle').text.to.equal(title);
            return this.api;
        },
